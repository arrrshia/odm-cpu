...
class ODM_Tree(object):
    def __init__(self, root_path, gcp_file = None, geo_file = None, align_file = None):
        ...
        self.infermod = os.path.join(self.root_path, 'inferencemod')
        ...
        # Inference model
        self.infer_image_outputdir = os.path.join(self.infermod, "images")
        self.infer_3dmodel = os.path.join(self.infermod, "inference_texturing")

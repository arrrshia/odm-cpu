...
class OSFMContext:
    ...
    def convert_and_undistort_inference_images(self, datasetPath, rerun=False, imageFilter=None, image_list=None, runId="nominal"):
        log.ODM_INFO("Undistorting %s ..." % datasetPath)
        #done_flag_file = self.path("undistorted", "%s_done.txt" % runId)
